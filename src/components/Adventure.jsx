        ...
        <div className="md:grid grid-cols-2 my-5 gap-8">
            <div className="grid grid-cols-2 gap-5 p-5">
                <div className="space-y-2">
                    ...
                    <p className="font-medium text-gray-700 text-opacity-60">Adventure Aegis offers a diverse range of exhilarating activities that cater to adventure of all ages and interests.</p>
                </div>
                <div className="space-y-2">
                    ...
                    <p className="font-medium text-gray-700 text-opacity-60">Adventure Aegis takes care of all your travel arrangements, ensuring a seamless and stress-free experience.</p>
                </div>
                <div className="space-y-2">
                    <img src={guide} className="w-20 h-20" alt="Private Guide" />
                    <h3 className="text-xl font-bold text-gray-600">Private Guide</h3>
                    <p className="font-medium text-gray-700 text-opacity-60">Experience the ultimate personalized adventure with Adventure Aegis's Private Guide service.</p>
                </div>
                <div className="space-y-2">
                    ...
                    <p className="font-medium text-gray-700 text-opacity-60">At Adventure Aegis, our Location Managers are the backbone of our operations.</p>
                </div>
            </div>
