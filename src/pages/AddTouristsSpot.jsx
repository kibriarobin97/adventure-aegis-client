                ...
                <fieldset className="p-5 rounded-md shadow-sm bg-[#EBEEF3]">
                    <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        ...
                        <div className="col-span-full sm:col-span-3">
                            ...
                            <select name="country" id="" className="w-full rounded-md p-1 focus:ring focus:ring-opacity-75 text-black focus:ring-violet-400 border-gray-700">
                        ...
                        <div className="col-span-full">
                            <input type="submit" className="btn btn-block bg-orange-400 text-white hover:bg-orange-600 duration-500" value="Add Spot" />
                        </div>
                    </div>
                </fieldset>
            </form>
